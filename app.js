...
separate arguments and returns an array where the first element is the
 sum of those three numbers, the second element is the product of those three numbers,  
 and the third and fourth elements are strings that EXACTLY follow this example and use 
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var total = sum(firstSum[0], c)[0];
  var firstProduct = multiply(a, b);
  var product = multiply(firstProduct[0], c)[0];
...
the sum of the numbers in the array, and the second element is a string that 
...
function multiplyArray(multArr) { //eslint-disable-line
  var product = multArr[0]; //Set product to the first number in the array

  //Continue to multiply the product by each remaining number in the array
...
of any length as its argument and returns an array whose first element 
is the product of those numbers, and the second element is a string that 
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  var product = dynamicArray[0]; //Set product to the first number in the array
